...
export default function Contact() {
  ...
  // Read selected plan from URL query and listen for changes
  useEffect(() => {
    ...
    // Listen for the popstate event triggered by the Pricing component
            ...
            >
              ...
              <div className="space-y-3">
                ...
                <input
                  ...
                  value={form.plan}
                  readOnly
                  className="w-full px-0 py-3 bg-zinc-100 border-b border-zinc-200 outline-none text-zinc-700"
                />
              </div>
